    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch('http://localhost:3000/api/auth/login', requestOptions)];
                case 2:
                    response = _a.sent();
                    if (!response.ok) {
...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.input)({ placeholder: ("email"), type: ("email"), });
    (__VLS_ctx.mail);
    __VLS_elementAsFunction(__VLS_intrinsicElements.input)({ placeholder: ("password"), type: ("password"), });
    (__VLS_ctx.mdp);
    __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)(__assign({ onClick: function () {
            ...
            var $event = _a[0];
            __VLS_ctx.fetchData(__VLS_ctx.mail, __VLS_ctx.mdp);
        } }));
